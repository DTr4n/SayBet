      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className={`glass-card p-6 mb-6 ${
          ...
          <div className="space-y-3 mb-6">
            <div className={`flex items-center text-lg ${isCompleted ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className={`flex items-center text-lg ${isCompleted ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <span>Hosted by {activity.host.name}</span>
            </div>
          </div>
        ...
        {(activity.interested.length > 0 || Object.values(activity.joinRequests).filter(r => r === 'maybe').length > 0) && (
          <div className="glass-card p-6">
            <h2 className="text-lg font-bold text-gray-800 mb-4">Who's Joining</h2>
            
            <div className="space-y-4">
              {activity.interested.length > 0 && (
                <div>
                  <h3 className="text-sm font-medium text-green-700 mb-2">Going ({activity.interested.length})</h3>
                  <div className="grid grid-cols-1 gap-2">
                    {activity.interested.map((userId) => (
                      <div key={userId} className="flex items-center space-x-3 px-3 py-2 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {Object.entries(activity.joinRequests)
                      ...
                      .map(([userId]) => (
                      <div key={userId} className="flex items-center space-x-3 px-3 py-2 bg-yellow-50 rounded-lg">
